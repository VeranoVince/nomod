...
function useMergedRefs(refA, refB) {
  return (0, import_react27.useMemo)(() => mergeRefs(refA, refB), [refA, refB]);
}
...
var TabContext = React22.createContext(null);
...
var NavItem = React23.forwardRef((_ref, ref) => {
  let {
    as: Component = Button_default,
    active,
    eventKey
  ...
  return (0, import_jsx_runtime17.jsx)(Component, Object.assign({}, options, props, {
    ref
  }));
});
...
var NavLink = React24.forwardRef(({
  bsPrefix,
  className,
  as: Component = Anchor_default,
  active,
  ...
  return (0, import_jsx_runtime18.jsx)(Component, {
    ...
    ref,
    disabled,
    className: (0, import_classnames9.default)(className, bsPrefix, disabled && "disabled", meta.isActive && "active")
  });
});
...
var NavDropdown = React25.forwardRef(({
  id,
  title,
  children,
  bsPrefix,
  ...
  return (0, import_jsx_runtime20.jsxs)(Dropdown_default2, {
    ref,
    ...props,
    className: (0, import_classnames10.default)(className, navItemPrefix),
    children: [(0, import_jsx_runtime19.jsx)(Dropdown_default2.Toggle, {
      id,
      eventKey: null,
      active,
      disabled,
      ...
      as: NavLink_default,
      children: title
    }), (0, import_jsx_runtime19.jsx)(Dropdown_default2.Menu, {
      role: menuRole,
...
//# sourceMappingURL=chunk-GGJL4X5V.js.map
