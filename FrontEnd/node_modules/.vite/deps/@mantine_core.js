...
var defaultCssVariablesResolver = (theme) => {
  ...
  theme.colors[theme.primaryColor].forEach((_, index4) => {
    result.variables[`--mantine-primary-color-${index4}`] = `var(--mantine-color-${theme.primaryColor}-${index4})`;
  });
  keys(theme.colors).forEach((color) => {
    theme.colors[color].forEach((shade, index4) => {
      result.variables[`--mantine-color-${color}-${index4}`] = shade;
    });
...
var useReactId2 = React39["useId".toString()];
...
var FloatingArrow = React39.forwardRef(function FloatingArrow2(_ref, ref) {
  ...
  return React39.createElement("svg", _extends2({}, rest, {
    "aria-hidden": true,
    ref,
...
function useHover2(context, props) {
  ...
  const closeWithDelay = React39.useCallback(function(event, runElseBranch) {
...
var FocusGuard = React39.forwardRef(function FocusGuard2(props, ref) {
  ...
  return React39.createElement("span", _extends2({}, props, restProps));
});
...
var VisuallyHiddenDismiss = React39.forwardRef(function VisuallyHiddenDismiss2(props, ref) {
  return React39.createElement("button", _extends2({}, props, {
    type: "button",
    ref,
    tabIndex: -1,
    style: HIDDEN_STYLES
...
var FloatingOverlay = React39.forwardRef(function FloatingOverlay2(_ref, ref) {
  ...
  return React39.createElement("div", _extends2({
    ref
  }, rest, {
    style: {
      position: "fixed",
...
function useInteractions(propsList) {
  ...
  const getReferenceProps = React39.useCallback(
    (userProps) => mergeProps(userProps, propsList, "reference"),
    // eslint-disable-next-line react-hooks/exhaustive-deps
    deps
  );
  const getFloatingProps = React39.useCallback(
...
function useTransition({
  ...
  (0, import_react124.useEffect)(() => () => window.clearTimeout(timeoutRef.current), []);
  return {
    transitionDuration,
    transitionStatus,
...
var ActionIcon = polymorphicFactory((_props, ref) => {
  ...
  return import_react140.default.createElement(
    ...
    import_react140.default.createElement(Box, { component: "span", ...getStyles2("loader"), "aria-hidden": true }, import_react140.default.createElement(Loader, { color: "var(--ai-color)", size: "calc(var(--ai-size) * 0.55)", ...loaderProps })),
...
var CloseIcon = (0, import_react141.forwardRef)(
  ({ size: size2 = "var(--cb-icon-size, 70%)", style, ...others }, ref) => import_react141.default.createElement(
    "svg",
    {
      viewBox: "0 0 15 15",
      fill: "none",
...
var ComboboxClearButton = (0, import_react200.forwardRef)(
  ({ size: size2, onMouseDown, onClick, onClear, ...others }, ref) => import_react200.default.createElement(
    CloseButton,
    {
      ref,
      size: size2 || "sm",
...
function useCombobox({
  ...
  const updateSelectedOptionIndex = (0, import_react213.useCallback)((target = "selected") => {
    selectedIndexUpdateTimeout.current = window.setTimeout(() => {
      const items = document.querySelectorAll(
        `#${listId.current} [data-combobox-option]`
      );
      const index4 = Array.from(items).findIndex(
...
var InlineInput = (0, import_react215.forwardRef)(
  ({
    ...
    return import_react215.default.createElement(
      ...
      import_react215.default.createElement("div", { ...getStyles2("body") }, children, import_react215.default.createElement("div", { ...getStyles2("labelWrapper"), "data-disabled": disabled || void 0 }, label && import_react215.default.createElement("label", { ...getStyles2("label"), "data-disabled": disabled || void 0, htmlFor: id }, label), description && import_react215.default.createElement(Input.Description, { size: size2, __inheritStyles: false, ...getStyles2("description") }, description), error && error !== "boolean" && import_react215.default.createElement(Input.Error, { size: size2, __inheritStyles: false, ...getStyles2("error") }, error)))
    );
  }
);
...
var CheckboxGroup = factory((props, ref) => {
  ...
  return import_react218.default.createElement(CheckboxGroupProvider, { value: { value: _value, onChange: handleChange, size: size2 } }, import_react218.default.createElement(
    Input.Wrapper,
    {
      size: size2,
      ref,
...
function Option({ data, withCheckIcon, value, checkIconPosition, unstyled }) {
  if (!isOptionsGroup(data)) {
    const check = withCheckIcon && isValueChecked(value, data.value) && import_react221.default.createElement(CheckIcon, { className: classes21.optionsDropdownCheckIcon });
    return import_react221.default.createElement(
      ...
      import_react221.default.createElement("span", null, data.label),
...
var Autocomplete = factory((_props, ref) => {
  ...
  return import_react222.default.createElement(
    ...
    import_react222.default.createElement(Combobox.Target, null, import_react222.default.createElement(
      InputBase,
      {
        ref,
        ...others,
  ...
  const items = import_react230.default.Children.toArray(children).reduce(
    (acc, child, index4, array) => {
      ...
      const item = isElement(child) ? import_react230.default.cloneElement(child, {
        ...
        key: index4
      }) : import_react230.default.createElement("div", { ...getStyles2("breadcrumb"), key: index4 }, child);
      acc.push(item);
      if (index4 !== array.length - 1) {
        acc.push(
          import_react230.default.createElement(Box, { ...getStyles2("separator"), key: `separator-${index4}` }, separator)
        );
      }
      return acc;
    },
...
var Button = polymorphicFactory((_props, ref) => {
  ...
  return import_react233.default.createElement(
    ...
    import_react233.default.createElement(Box, { component: "span", ...getStyles2("loader"), "aria-hidden": true }, import_react233.default.createElement(
      Loader,
      {
...
var Center = polymorphicFactory((_props, ref) => {
  ...
  return import_react237.default.createElement(Box, { ref, mod: [{ inline: inline2 }, mod], ...getStyles2("root"), ...others });
});
...
var ColorSlider = factory((_props, ref) => {
  ...
  const layers = overlays.map((overlay, index4) => import_react245.default.createElement("div", { ...getStyles2("sliderOverlay"), style: overlay, key: index4 }));
...
var Swatches = (0, import_react249.forwardRef)(
  ({
    ...
    const colors = data.map((color, index4) => import_react249.default.createElement(
      ColorSwatch,
      {
...
function useVirtualizedCombobox({
  ...
  const selectOption = (index4) => {
    const nextIndex = index4 >= totalOptionsCount ? 0 : index4 < 0 ? totalOptionsCount - 1 : index4;
...
var Indicator = factory((_props, ref) => {
  ...
  return import_react286.default.createElement(Box, { ref, ...getStyles2("root"), mod: [{ inline: inline2 }, mod], ...others }, !disabled && import_react286.default.createElement(import_react286.default.Fragment, null, import_react286.default.createElement(
    Box,
    {
...
var index2 = import_react287.useLayoutEffect;
...
var index3 = React163.forwardRef(TextareaAutosize);
...
var MenuDropdown = factory((props, ref) => {
  ...
  return import_react298.default.createElement(
    ...
    import_react298.default.createElement("div", { tabIndex: -1, "data-autofocus": true }),
    children
  );
});
...
var ModalContent = factory((_props, ref) => {
  ...
  return import_react307.default.createElement(
    ...
    import_react307.default.createElement(Scroll, { style: { maxHeight: `calc(100vh - (${rem(ctx.yOffset)} * 2))` } }, children)
  );
});
...
var ModalRoot = factory((_props, ref) => {
  ...
  return import_react310.default.createElement(ModalProvider, { value: { yOffset, scrollAreaComponent, getStyles: getStyles2 } }, import_react310.default.createElement(
    ModalBase,
    {
      ref,
      ...getStyles2("root"),
...
var PillsInput = factory((_props, ref) => {
  ...
  return import_react318.default.createElement(PillsInputProvider, { value: { fieldRef, size: size2, disabled, hasError: !!error, variant } }, import_react318.default.createElement(
    InputBase,
    {
      size: size2,
      error,
...
var MultiSelect = factory((_props, ref) => {
  ...
  const values2 = _value.map((item, index4) => {
    var _a, _b;
  ...
  return import_react320.default.createElement(import_react320.default.Fragment, null, import_react320.default.createElement(
    ...
    import_react320.default.createElement(Combobox.DropdownTarget, null, import_react320.default.createElement(
      PillsInput,
      {
        ...
        disabled,
        radius,
        rightSection: rightSection || clearButton || import_react320.default.createElement(Combobox.Chevron, { size: size2, error, unstyled }),
      ...
      import_react320.default.createElement(Pill.Group, { disabled, unstyled, ...getStyles2("pillsList") }, values2, import_react320.default.createElement(Combobox.EventsTarget, null, import_react320.default.createElement(
        PillsInput.Field,
        {
          ...rest,
          ref,
...
var NativeSelect = factory((props, ref) => {
  ...
  const options = getParsedComboboxData(data).map((item, index4) => import_react322.default.createElement(NativeSelectOption, { key: index4, data: item }));
  return import_react322.default.createElement(
    InputBase,
    {
      ...
      error,
      unstyled,
      rightSection: rightSection || import_react322.default.createElement(ComboboxChevron, { size: size2, error, unstyled })
    },
    children || options
  );
});
...
var NavLink = polymorphicFactory((_props, ref) => {
  ...
  ), import_react323.default.createElement(Collapse, { in: _opened }, import_react323.default.createElement("div", { ...getStyles2("children") }, children)));
});
...
function removeFormatting(value, changeMeta, props) {
  ...
  value = value.replace(new RegExp(escapeRegExp(decimalSeparator), "g"), function(match, index4) {
...
function PaginationItems({ dotsIcon }) {
  ...
  const items = ctx.range.map((page, index4) => {
    var _a;
    if (page === "dots") {
      return import_react334.default.createElement(PaginationDots, { icon: dotsIcon, key: index4 });
    }
...
var PinInput = factory((props, ref) => {
  ...
  const focusInputField = (dir, index4) => {
    if (!manageFocus)
      return;
    if (dir === "next") {
      const nextIndex = index4 + 1;
      inputsRef.current[nextIndex < (length ?? 0) ? nextIndex : index4].focus();
    }
    if (dir === "prev") {
      const nextIndex = index4 - 1;
      inputsRef.current[nextIndex > -1 ? nextIndex : index4].focus();
    }
  };
  const setFieldValue = (val, index4) => {
    const values2 = [...createPinArray(length ?? 0, _value)];
    values2[index4] = val;
    setValues(values2.join(""));
  };
  const handleChange = (event, index4) => {
    ...
    if (nextCharOrValue.length < 2) {
      if (isValid) {
        setFieldValue(nextCharOrValue, index4);
        focusInputField("next", index4);
      } else {
        setFieldValue("", index4);
      }
    } else if (isValid) {
      setValues(inputValue);
    }
  };
  const handleKeyDown = (event, index4) => {
    if (event.key === "ArrowLeft") {
      event.preventDefault();
      focusInputField("prev", index4);
  ...
  const handleFocus = (event, index4) => {
    event.target.select();
    setFocusedIndex(index4);
  };
  const handleBlur = () => {
    setFocusedIndex(-1);
  };
  ...
  return import_react339.default.createElement(import_react339.default.Fragment, null, import_react339.default.createElement(
    ...
    createPinArray(length ?? 0, _value).map((char, index4) => import_react339.default.createElement(
      Input,
      {
        component: "input",
        ...getStyles2("pinInput", {
        ...
        onChange: (event) => handleChange(event, index4),
        onKeyDown: (event) => handleKeyDown(event, index4),
        onFocus: (event) => handleFocus(event, index4),
        onBlur: handleBlur,
        onPaste: handlePaste,
        ...
        disabled,
        ref: (node) => {
          index4 === 0 && assignRef2(ref, node);
          inputsRef.current[index4] = node;
        },
        autoComplete: oneTimeCode ? "one-time-code" : "off",
        placeholder: focusedIndex === index4 ? "" : placeholder,
        value: char,
        autoFocus: autoFocus && index4 === 0,
        unstyled,
        "aria-label": ariaLabel,
        readOnly
      }
    ))
  ), import_react339.default.createElement("input", { type: "hidden", name, form, value: _value, ...hiddenInputProps }));
});
...
var RadioGroup = factory((props, ref) => {
  ...
  return import_react346.default.createElement(RadioGroupProvider, { value: { value: _value, onChange: handleChange, size: size2, name: _name } }, import_react346.default.createElement(
    Input.Wrapper,
    {
      size: size2,
      ref,
...
var RingProgress = factory((_props, ref) => {
  ...
  const curves = getCurves({
    ...
    rootColor
  }).map(({ data, sum, root, lineRoundCaps, offset: offset2 }, index4) => import_react365.default.createElement(
    Curve,
    {
      ...data,
      key: index4,
  ...
  return import_react365.default.createElement(Box, { ...getStyles2("root"), size: size2, ref, ...others }, import_react365.default.createElement("svg", { ...getStyles2("svg") }, curves), label && import_react365.default.createElement("div", { ...getStyles2("label") }, label));
});
...
var Select = factory((_props, ref) => {
  ...
  return import_react367.default.createElement(import_react367.default.Fragment, null, import_react367.default.createElement(
    ...
    import_react367.default.createElement(Combobox.Target, { targetType: searchable ? "input" : "button" }, import_react367.default.createElement(
      InputBase,
      {
        id: _id,
        ref,
        rightSection: rightSection || clearButton || import_react367.default.createElement(Combobox.Chevron, { size: size2, error, unstyled }),
        rightSectionPointerEvents: rightSectionPointerEvents || (clearButton ? "all" : "none"),
        ...others,
        size: size2,
        __staticSelector: "Select",
...
function Marks({ marks, min, max, disabled, value, offset: offset2, inverted }) {
  ...
  const items = marks.map((mark, index4) => import_react374.default.createElement(
    Box,
    {
...
var RangeSlider = factory((_props, ref) => {
  ...
  function handleThumbMouseDown(index4) {
  ...
  return import_react377.default.createElement(SliderProvider, { value: { getStyles: getStyles2 } }, import_react377.default.createElement(SliderRoot, { ...others, size: size2, ref, disabled }, import_react377.default.createElement(
    Track,
    {
      offset: positions[0],
...
var Stepper = factory((_props, ref) => {
  ...
  const items = _children.reduce((acc, item, index4) => {
    ...
    acc.push(
      (0, import_react383.cloneElement)(item, {
        ...
        step: index4,
        state,
        onClick: () => isStepSelectionEnabled && (onStepClick == null ? void 0 : onStepClick(index4)),
      ...
      acc.push(
        import_react383.default.createElement(
          "div",
          {
            ...
            "data-active": index4 < active || void 0,
  ...
  return import_react383.default.createElement(StepperProvider, { value: { getStyles: getStyles2, orientation, iconPosition } }, import_react383.default.createElement(Box, { ...getStyles2("root"), ref, size: size2, ...others }, import_react383.default.createElement(
    Box,
    {
      ...getStyles2("steps"),
      mod: {
...
var SwitchGroup = factory((props, ref) => {
  ...
  return import_react385.default.createElement(SwitchGroupProvider, { value: { value: _value, onChange: handleChange, size: size2 } }, import_react385.default.createElement(
    Input.Wrapper,
    {
      size: size2,
      ref,
...
function TableDataRenderer({ data }) {
  return import_react389.default.createElement(import_react389.default.Fragment, null, data.caption && import_react389.default.createElement(TableCaption, null, data.caption), data.head && import_react389.default.createElement(TableThead, null, import_react389.default.createElement(TableTr, null, data.head.map((item, index4) => import_react389.default.createElement(TableTh, { key: index4 }, item)))), data.body && import_react389.default.createElement(TableTbody, null, data.body.map((row, rowIndex) => import_react389.default.createElement(TableTr, { key: rowIndex }, row.map((item, index4) => import_react389.default.createElement(TableTd, { key: index4 }, item))))), data.foot && import_react389.default.createElement(TableTfoot, null, import_react389.default.createElement(TableTr, null, data.foot.map((item, index4) => import_react389.default.createElement(TableTh, { key: index4 }, item)))));
}
...
var TagsInput = factory((_props, ref) => {
  ...
  const values2 = _value.map((item, index4) => import_react398.default.createElement(
    Pill,
    {
      key: `${item}-${index4}`,
  ...
  return import_react398.default.createElement(import_react398.default.Fragment, null, import_react398.default.createElement(
    ...
    import_react398.default.createElement(Combobox.DropdownTarget, null, import_react398.default.createElement(
      ...
      import_react398.default.createElement(Pill.Group, { disabled, unstyled, ...getStyles2("pillsList") }, values2, import_react398.default.createElement(Combobox.EventsTarget, null, import_react398.default.createElement(
        PillsInput.Field,
        {
          ...rest,
          ref,
  ...
  const items = _children.map(
    (item, index4) => {
      ...
      return (0, import_react403.cloneElement)(item, {
        unstyled,
        __align: align,
        __active: ((_a = item.props) == null ? void 0 : _a.active) || (reverseActive ? active >= _children.length - index4 - 1 : active >= index4),
        __lineActive: ((_b = item.props) == null ? void 0 : _b.lineActive) || (reverseActive ? active >= _children.length - index4 - 1 : active - 1 >= index4)
      });
    }
  );
