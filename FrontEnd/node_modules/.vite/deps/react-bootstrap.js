import {
  Image_default,
  propTypes
} from "./chunk-7OTRGPVM.js";
import {
  Row_default
} from "./chunk-XL36NINC.js";
import {
  ENTERED,
  ENTERING,
  EXITED,
...
import {
  ...
  useWindow
} from "./chunk-GGJL4X5V.js";
import "./chunk-IMWHDCIP.js";
import {
  Container_default
} from "./chunk-TUAG6JSW.js";
import {
  Col_default,
  useCol
} from "./chunk-ZIYESZDY.js";
import {
  DEFAULT_BREAKPOINTS,
...
var Alert = React16.forwardRef((uncontrolledProps, ref) => {
  ...
  return (0, import_jsx_runtime14.jsx)(Transition, {
    unmountOnExit: true,
    ...props,
    ref: void 0,
    in: show,
...
function useUpdateEffect(fn, deps) {
  const isFirst = (0, import_react10.useRef)(true);
...
function useTimeout() {
  ...
  const handleRef = (0, import_react13.useRef)();
...
var Nav = React59.forwardRef((_ref, ref) => {
  ...
  const needsRefocusRef = (0, import_react24.useRef)(false);
  const parentOnSelect = (0, import_react24.useContext)(SelectableContext_default);
  const tabContext = (0, import_react24.useContext)(TabContext_default);
  ...
  const listNode = (0, import_react24.useRef)(null);
...
function NoopTransition({
  ...
  const hasEnteredRef = (0, import_react26.useRef)(inProp);
  ...
  const child = (0, import_react26.cloneElement)(children, {
    ref: combinedRef
  });
  if (inProp)
    return child;
...
var Modal = (0, import_react28.forwardRef)((_ref, ref) => {
  ...
  let dialog = renderDialog ? renderDialog(dialogProps) : (0, import_jsx_runtime65.jsx)("div", Object.assign({}, dialogProps, {
    children: React63.cloneElement(children, {
      role: "document"
    })
  }));
...
var ModalBody = React64.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var ModalDialog = React66.forwardRef(({
  bsPrefix,
  className,
  contentClassName,
  centered,
...
var ModalFooter = React67.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var ModalTitle = React70.forwardRef(({
  className,
  bsPrefix,
...
var Modal2 = React71.forwardRef(({
  ...
  const renderBackdrop = (0, import_react30.useCallback)((backdropProps) => (0, import_jsx_runtime75.jsx)("div", {
    ...backdropProps,
...
var NavItem = React72.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var Offcanvas = React81.forwardRef(({
  ...
  const renderBackdrop = (0, import_react36.useCallback)((backdropProps) => (0, import_jsx_runtime85.jsx)("div", {
    ...backdropProps,
...
// node_modules/@restart/ui/esm/Overlay.js
var Overlay = React85.forwardRef((props, outerRef) => {
  const {
    flip,
    offset,
    placement,
...
var PopoverHeader = React86.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var PopoverBody = React87.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var Popover = React89.forwardRef(({
  bsPrefix,
  placement = "right",
  className,
  style: style2,
...
var Tooltip = React90.forwardRef(({
  bsPrefix,
  placement = "right",
  className,
  style: style2,
...
var Overlay2 = React91.forwardRef(({
  children: overlay,
  transition = Fade_default,
  popperConfig = {},
  rootClose = false,
  ...
  return (0, import_jsx_runtime97.jsx)(Overlay_default, {
    ...
    children: (overlayProps, {
      ...
      return React91.cloneElement(overlay, {
        ...overlayProps,
        placement: updatedPlacement,
        arrowProps,
        popper,
...
var OverlayTrigger = ({
  ...
  const {
    ...
    onBlur,
    onClick
  } = typeof children !== "function" ? React92.Children.only(children).props : {};
  const attachRef = (r) => {
    mergedRef(safeFindDOMNode(r));
  };
  ...
  return (0, import_jsx_runtime100.jsxs)(import_jsx_runtime99.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react43.cloneElement)(children, triggerProps), (0, import_jsx_runtime98.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip,
...
var PageItem = React93.forwardRef(({
  active = false,
  disabled = false,
  className,
  style: style2,
...
function createButton(name, defaultValue, label = name) {
  const Button = React93.forwardRef(({
    children,
    ...props
...
var Pagination = React94.forwardRef(({
  bsPrefix,
  className,
  size: size2,
  ...props
...
var PlaceholderButton = React95.forwardRef((props, ref) => {
  const placeholderProps = usePlaceholder(props);
  return (0, import_jsx_runtime104.jsx)(Button_default, {
    ...placeholderProps,
    ref,
    disabled: true,
    tabIndex: -1
...
var Placeholder = React96.forwardRef(({
  as: Component2 = "span",
  ...props
}, ref) => {
  const placeholderProps = usePlaceholder(props);
...
var ProgressBar = React97.forwardRef(({
  isChild = false,
  ...rest
}, ref) => {
  const props = {
...
var Ratio = React98.forwardRef(({
  ...
  return (0, import_jsx_runtime107.jsx)("div", {
    ...
    children: React98.Children.only(children)
  });
});
...
var Spinner = React99.forwardRef(({
  bsPrefix,
  variant,
  animation = "border",
  size: size2,
...
var SplitButton = React100.forwardRef(({
  id,
  bsPrefix,
  size: size2,
  variant,
  ...
  flip,
  ...props
}, ref) => (0, import_jsx_runtime110.jsxs)(Dropdown_default, {
  ref,
  ...props,
  ...
  children: [(0, import_jsx_runtime109.jsx)(Button_default, {
    ...
    type,
    children: title
  }), (0, import_jsx_runtime109.jsx)(Dropdown_default.Toggle, {
    split: true,
    id,
    size: size2,
    variant,
    disabled: props.disabled,
    childBsPrefix: bsPrefix,
    children: (0, import_jsx_runtime109.jsx)("span", {
      className: "visually-hidden",
      children: toggleLabel
    })
  }), (0, import_jsx_runtime109.jsx)(Dropdown_default.Menu, {
    role: menuRole,
    renderOnMount: renderMenuOnMount,
    rootCloseEvent,
    flip,
...
var TabPanel = React102.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  (_ref2, ref) => {
    let {
      as: Component2 = "div"
    ...
    return (0, import_jsx_runtime112.jsx)(TabContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime112.jsx)(SelectableContext_default.Provider, {
        ...
        children: (0, import_jsx_runtime112.jsx)(Transition, {
          ...
          mountOnEnter,
          unmountOnExit,
          children: (0, import_jsx_runtime112.jsx)(Component2, Object.assign({}, tabPanelProps, {
            ref,
            hidden: !isActive,
...
var TabContainer = ({
  transition,
  ...props
}) => (0, import_jsx_runtime114.jsx)(Tabs_default, {
  ...props,
...
var TabContent = React105.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var TabPane = React106.forwardRef(({
  ...
  return (0, import_jsx_runtime116.jsx)(TabContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime116.jsx)(SelectableContext_default.Provider, {
      value: null,
      children: (0, import_jsx_runtime116.jsx)(Transition, {
        in: isActive,
        onEnter,
        onEntering,
        onEntered,
        ...
        mountOnEnter,
        unmountOnExit,
        children: (0, import_jsx_runtime116.jsx)(Component2, {
          ...rest,
          ref,
...
var ToastFade = React109.forwardRef((props, ref) => (0, import_jsx_runtime120.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastContext = React110.createContext({
  // eslint-disable-next-line @typescript-eslint/no-empty-function
  onClose() {
  }
});
...
var ToastHeader = React111.forwardRef(({
  bsPrefix,
  closeLabel = "Close",
  closeVariant,
  closeButton = true,
...
var ToastBody = React112.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var Toast = React113.forwardRef(({
  ...
  const toast = (0, import_jsx_runtime124.jsx)("div", {
    ...props,
    ref,
  ...
  return (0, import_jsx_runtime124.jsx)(ToastContext_default.Provider, {
    value: toastContext,
    children: hasAnimation && Transition ? (0, import_jsx_runtime124.jsx)(Transition, {
      in: show,
      onEnter,
      onEntering,
      onEntered,
...
var ToggleButton = React115.forwardRef(({
  ...
  return (0, import_jsx_runtime128.jsxs)(import_jsx_runtime127.Fragment, {
    children: [(0, import_jsx_runtime126.jsx)("input", {
      className: bsPrefix,
      name,
      type,
      value,
      ...
      id
    }), (0, import_jsx_runtime126.jsx)(Button_default, {
      ...props,
      ref,
...
var ToggleButtonGroup = React116.forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime129.jsx)(ButtonGroup_default, {
    ...controlledProps,
    ref,
    vertical,
    children: map(children, (child) => {
